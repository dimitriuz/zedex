...
final class Machine {
    ...
    static final String PREF_MACHINE = SettingsActivity.KEY_MACHINE;
    ...
    Machine(Activity activity, SharedPreferences preferences, Host host) {
