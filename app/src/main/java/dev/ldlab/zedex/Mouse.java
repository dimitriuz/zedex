...
final class Mouse {
     ...
     */
    static void setEnabled(boolean wanted) {
        if (on == wanted) return;
    ...
    static void setSensitivity(int percent) {
    ...
    static void drag(float dx, float dy) {
        if (!on) return;
    ...
    static void steer(int direction, boolean pressed) {
    ...
    static void stick(float x, float y) {
        stickX = x;
        stickY = y;
    ...
    static void button(int which, boolean down) {
