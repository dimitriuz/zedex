...
public final class Pokes {
    ...
    public static final String KEY_POKES = "pokes";
    ...
    public static final class Poke {
        ...
        public Poke(String name, int address, int value) {
            this.name = name;
    ...
    public static List<Poke> all(SharedPreferences preferences) {
    ...
    public static void add(SharedPreferences preferences, String name,
    ...
    public static void remove(SharedPreferences preferences, int index) {
        List<Poke> pokes = all(preferences);
     ...
     */
    public static int number(String text, int most) {
