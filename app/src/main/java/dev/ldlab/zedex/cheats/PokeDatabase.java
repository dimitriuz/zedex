 ...
 */
public final class PokeDatabase {
    ...
    public static final class Trainer {
        ...
        public final List<Poke> pokes = new ArrayList<>();
     ...
     */
    public static PokeDatabase open(Context context) {
    ...
    public List<Game> search(String text, int limit) {
     ...
     */
    public static List<Trainer> parse(String text) {
