...
final class ControlsUi {
    ...
    ControlsUi(Activity activity, SharedPreferences preferences,
    ...
    SpectrumKeyboardView.Skin keyboardSkin() {
    ...
    void showJoystick(boolean shown) {
    ...
    void showKeyboard(boolean shown) {
