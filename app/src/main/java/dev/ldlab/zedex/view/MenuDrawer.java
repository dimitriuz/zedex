...
public final class MenuDrawer extends FrameLayout implements Rows {
    ...
    public void addItem(String text, int icon, Runnable action) {
     ...
     */
    public void addItem(String text, int icon, Runnable action, Runnable longPress) {
     ...
     * item's name in it.
     */
    public void addItem(String text, int icon, Runnable action, int trailingIcon,
     ...
     */
    public void addChoice(String text, boolean chosen, Runnable action) {
    ...
    public void addSubmenu(String text, int icon, Page page) {
     ...
     */
    public void addSubmenu(String text, String heading, int icon, Page page) {
     ...
     */
    public EditText addField(String hint, String initial, int inputType) {
    ...
    /**
     * Slides to a page from a sheet that is already open - which a row's own
     * button has to do itself, since it is not the row's click and so does not
     * go through {@link #addSubmenu}.
     */
    public void enter(String name, Page page) {
        trail.add(page);
        names.add(name);
        show(1);
    }
    ...
    public void setOnClosed(Runnable action) {
        onClosed = action;
    }
