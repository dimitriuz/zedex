 ...
 */
public final class ControlProfiles {
    ...
    public static final String KEY_PROFILES = "controlProfiles";

    /** Which of them is in use, as an index. */
    public static final String KEY_CURRENT = "controlProfile";
     ...
     */
    public static List<Profile> all(SharedPreferences preferences) {
        List<Profile> profiles = new ArrayList<>();
    ...
    public static final String QAOPM_NAME = "QAOPM";

    /** Which profile is in use; always a profile that exists. */
    public static int currentIndex(SharedPreferences preferences) {
    ...
    public static Profile current(SharedPreferences preferences) {
        return all(preferences).get(currentIndex(preferences));
    }

    /** Writes the lot back, and which one of them is in use. */
    public static void store(SharedPreferences preferences, List<Profile> profiles,
                      int current) {
