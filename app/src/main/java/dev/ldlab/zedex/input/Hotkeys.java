...
public final class Hotkeys {
    ...
    public static final String KEY_MODIFIER = "hotkeyButton";

    /** A JSON object of action name to keycode. */
    public static final String KEY_BINDINGS = "hotkeyBindings";
    ...
    public static final class Bindings {
        ...
        public Bindings(int modifier) {
            this.modifier = modifier;
        }

        public void put(Action action, int keycode) {
    ...
    public static Bindings load(SharedPreferences preferences) {
    ...
    public static int modifier(SharedPreferences preferences) {
        return preferences.getInt(KEY_MODIFIER, KeyEvent.KEYCODE_BUTTON_SELECT);
    }

    public static void setModifier(SharedPreferences preferences, int keycode) {
        preferences.edit().putInt(KEY_MODIFIER, keycode).apply();
    }

    /** The button bound to an action, for the editor to show. 0 for none. */
    public static int keycodeFor(SharedPreferences preferences, Action action) {
        String stored = preferences.getString(KEY_BINDINGS, null);
     ...
     */
    public static void bind(SharedPreferences preferences, Action action, int keycode) {
