...
public final class Controls {
     ...
     */
    public static final int JOYSTICK_KEYBOARD = 1000;
     ...
     */
    public static final int JOYSTICK_KEMPSTON = 2;
    ...
    public static void setPadSendsKeys(boolean sendsKeys) {
        padSendsKeys = sendsKeys;
    }

    /** Whether the pad's controls are keys, which fire says on its face. */
    public static boolean padSendsKeys() {
        return padSendsKeys;
    }
     ...
     */
    public static void press(int button, boolean pressed) {
    ...
    public static void pressKey(int slot, boolean pressed) {
